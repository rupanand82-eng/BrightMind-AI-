...
// Dynamic configuration selection (prefer client-side environment variables for production/Vercel hosting)
...
export const db = getFirestore(app, firebaseConfigActive.firestoreDatabaseId);
